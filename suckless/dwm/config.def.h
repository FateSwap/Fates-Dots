...
static const char sel_bg[] = "#637B86";
...
static const char *incvol[] = {"wpctl", "set-volume", "@DEFAULT_SINK@", ".05+", NULL};
static const char *decvol[] = {"wpctl", "set-volume", "@DEFAULT_SINK@", ".05-", NULL};
